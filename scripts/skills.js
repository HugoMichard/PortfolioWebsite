...
const skills = {
    "AI": {
        "AI Research Engineer": [
            {"technology": "LLM", "stars": 4, "projects": [
                {"title": "WebsiteGPT", "descriptions": ["WebsiteGPT is a no-code platform to build custom assistants powered by ChatGPT", "You can precise any documents or websites and build an assistant that will answer your customers based on the data contained in the documents and websites.", "I worked alone on this project and built both frontend and backend, as well as the website scrapping and RAG building."], "duration": "4 month", "other": "Python, Django, Vue, Nuxt", "link": {"before": "Project home page: ", "href": "https://hugomichard.github.io/PortfolioWebsiteGPT/"}},
                {"title": "TextClassifier", "descriptions": ["Text Classifier is an API available on Apify that leverages OpenAI's API to classify text into categories.", "The user simply defines his categories and his texts will be classified into those using the OpenAI API to make the GPT magic happen.", "As the project runs on Apify, I built an Apify actor and used OpenAI's tool functionalities to create a dedicated ChatGPT tool for the user's categories."], "duration": "1 month", "other": "Apify", "link": {"before": "Apify actor page: ", "href": "https://apify.com/quenchless_time/textclassifier"}}
            ]},
        ...
        "Data Engineer": [
            ...
            {"technology": "Data Scrapping", "stars": 4, "projects": [
                ...
                {"title": "WebsiteGPT", "descriptions": ["WebsiteGPT is a no-code platform to build custom assistants powered by ChatGPT", "You can precise any documents or websites and build an assistant that will answer your customers based on the data contained in the documents and websites.", "I worked alone on this project and built both frontend and backend, as well as the website scrapping and RAG building."], "duration": "4 month", "other": "LLM, Python, Django, Vue, Nuxt", "link": {"before": "Project home page: ", "href": "https://hugomichard.github.io/PortfolioWebsiteGPT/"}},
            ]}
        ]
    },
    "Software Development": {
        "Frontend": [
            ...
            {"technology": "Vue", "stars": 4, "projects": [
                {"title": "Nausikaa", "descriptions": ["Nausikaa is an anomaly detection project on Relational Databases.", "An interface allows users to setup their configurations such as their database credentials, their prefered alert methods (slack or email) and parameters defining abnormality in their data.", "When abnormal data is received in their databases, an alert is sent so they may detect it and fix it quickly !"], "duration": "5 months", "other": "Django, PostgreSQL", "link": {"before": "The project page can be accessed here ", "href": "https://hugomichard.github.io/PortfolioWebsite/projects/nausikaa/index"}},
                {"title": "WebsiteGPT", "descriptions": ["WebsiteGPT is a no-code platform to build custom assistants powered by ChatGPT", "You can precise any documents or websites and build an assistant that will answer your customers based on the data contained in the documents and websites.", "I worked alone on this project and built both frontend and backend, as well as the website scrapping and RAG building."], "duration": "4 month", "other": "LLM, Python, Django, Nuxt", "link": {"before": "Project home page: ", "href": "https://hugomichard.github.io/PortfolioWebsiteGPT/"}},
                {"title": "KoalAPI", "descriptions": ["KoalAPI is a platform to build APIs to share and sell your databases and files in a few clicks", "You can add your data sources and easily invite your customers to join. You can set custom payment plans and define specific access to your data.", "I worked alone on this project and built both frontend and backend, as well as the payment solution."], "duration": "6 month", "other": "Python, Django, Nuxt", "link": {"before": "Project home page: ", "href": "https://hugomichard.github.io/PortfolioKoalapi/"}},
            ]},
        ],
        "Backend": [
            ...
            {"technology": "Django", "stars": 4, "projects": [
                ...
                {"title": "WebsiteGPT", "descriptions": ["WebsiteGPT is a no-code platform to build custom assistants powered by ChatGPT", "You can precise any documents or websites and build an assistant that will answer your customers based on the data contained in the documents and websites.", "I worked alone on this project and built both frontend and backend, as well as the website scrapping and RAG building."], "duration": "4 month", "other": "LLM, Vue, Nuxt", "link": {"before": "Project home page: ", "href": "https://hugomichard.github.io/PortfolioWebsiteGPT/"}},
                {"title": "KoalAPI", "descriptions": ["KoalAPI is a platform to build APIs to share and sell your databases and files in a few clicks", "You can add your data sources and easily invite your customers to join. You can set custom payment plans and define specific access to your data.", "I worked alone on this project and built both frontend and backend, as well as the payment solution."], "duration": "6 month", "other": "Python, Vue, Nuxt", "link": {"before": "Project home page: ", "href": "https://hugomichard.github.io/PortfolioKoalapi/"}},
            ]},
            ...
            {"technology": "SQL (with MySQL, PostgreSQL)", "stars": 4, "projects": [
                ...
                {"title": "Autonomous Videobooth", "descriptions": ["I created an autonomous recording and streaming videobooth for MemoRecords, a french audiovisual start-up.", "The videobooth starts automatically without human interaction and records the user while displaying surveys.", "With the videobooth, I developed a full-stack management software to handle the videos and simplify the video postprocessing."], "duration": "6 months", "other": "MySQL, Data Management, Data Visualization", "link": {"before": "Videos recorded by the videobooth are on the website ", "href": "https://memorec.fr/"}},
                {"title": "Nausikaa", "descriptions": ["Nausikaa is an anomaly detection project on Relational Databases.", "An interface allows users to setup their configurations such as their database credentials, their prefered alert methods (slack or email) and parameters defining abnormality in their data.", "When abnormal data is received in their databases, an alert is sent so they may detect it and fix it quickly !"], "duration": "5 months", "other": "Vue, Django", "link": {"before": "The project page can be accessed here ", "href": "https://hugomichard.github.io/PortfolioWebsite/projects/nausikaa/index"}},
            ]}
        ]
    }
}
